import { createEnv } from "./src-Cq4nGjdj.js";
import { optional, picklist, pipe, string, url } from "valibot";

//#region src/presets-valibot.ts
/**
...
const uploadthingV6 = () => createEnv({
	server: { UPLOADTHING_TOKEN: string() },
	runtimeEnv: process.env
});
/**
...
const render = () => createEnv({
	server: {
		...
		RENDER_SERVICE_TYPE: optional(picklist([
			"web",
			"pserv",
			"cron",
			"worker",
...
//#endregion
export { fly, neonVercel, netlify, railway, render, uploadthing, uploadthingV6, upstashRedis, vercel };